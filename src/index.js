...
async function playRageEngine(character1, character2){
    for(let i=1; i <= 5 ; i++){
        ...
        if(block === 'CONFRONTO'){
            ...
            await logRollResult(character1.NOME, "confronto", powerResult1, character1.PODER)
            await logRollResult(character2.NOME, "confronto", powerResult2, character2.PODER)
            ...
            //character2.PONTOS -= powerResult1 > powerResult2 && character1.PONTOS > 0 ? 1 : 0;
...
(async function main(){
    ...
    await playRageEngine(player1, player2);
